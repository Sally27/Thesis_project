...
\newglossaryentry{VELO}
                 {
                   name=VELO,
                   description={VErtex LOcator. One of the LHCb detector subsystems, placed around the $pp$ interaction point, used to realise the precise measurements of vertices and tracks}
                 }
\newglossaryentry{TTandTstations}
                 {
                   name=TT and T station,
                   description={The TT station is a tracker made of silicon micro strips and  sits upstream of the magnet. The T station is a tracker made of silicon micro strips in the inner section and straw tubes in the outer section. It sits downstream of the magnet  }
                 }
   \newglossaryentry{longtracks}
              {
                   name=long track ,
