...
\newglossaryentry{trackchi2ndof}
{
		...
		description={The track $\chi^{2}$ per degree of freedom is the minimal difference in fit $\chi^{2}$ (quality of the fit) to the primary vertex between fit with this track added  and removed} %sally}
		}
