...
\def\bmumupi{\decay{\Bp}{\ensuremath{\mumu\pip}}\xspace}
\def\bmumuk{\decay{\Bp}{\ensuremath{\mumu\Kp}}\xspace}
%$\mathcal{B}(B^+ \rightarrow K^+ \pi^- \mu^+ \mu^{-} )
\def\pr{\decay{\Bp}{\ensuremath{(\decay{\Dz}{\Kp\pim\mumu})\mup\nu}}\xspace}
\def\bjpsikst{\decay{\Bz}{\ensuremath{(\decay{\jpsi}{\mumu})(\decay{\Kstar}{\pip\Km})}}\xspace} 
