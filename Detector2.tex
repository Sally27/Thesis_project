...
\Gls{L0} reduces the rate of data from 40 MHz to 1 MHz by employing five trigger decisions, also known as lines. First three lines make desicion using calorimeter information about the transverse energy deposited for photon, electron, and hadron. Two other lines are triggered by looking for transverse momentum for muon and dimuon (two muon tracks) objects.

Secondly the High Level Trigger (HLT) reduces the data rate
