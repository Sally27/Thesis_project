...
In order to measure the perfomance of the PID computed by RICH, populous samples need to be analyzed.
The PID performance of the RICH is assesed using set of standard candle
