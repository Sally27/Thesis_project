...
Despite the complexity and best intention of the \Gls{LHCb} simulation, there are several shortcomings that represent different degrees of obstacles of its use.
The most afftected variables necessary for physics analyses that one needs to consider are impact parameter, track reconstruction efficiencies,\Gls{PID} variables and track occupancy.
...
J/ψ → μ+μ− decays [15]. There are slightly larger data-simulation deviations in some
