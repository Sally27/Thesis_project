...
$\pi^{+} \pi^{-}$ invariant mass spectra in $B^{0} \rightarrow h^{+} h^{-}$ with and without PID requirements, \autoref{fig:richnice}, demonstrates clear increase in sensitivity searching for $B^{0} \rightarrow \pi^{+} \pi^{-}$ signal. 
