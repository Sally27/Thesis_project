...
\includegraphics[width=0.5\textwidth]{theory/rhoeta-fullfit-sm.eps}\put(-30,100){(a)}
\includegraphics[width=0.5\textwidth]{theory/rhoeta_large_lol.eps}\put(-30,100){(b)}
