...
\pagestyle{fancy}
\cleardoublepage
\input{introduction_sally_cor}
%% \cleardoublepage
\input{Theory_Sally_cor}
\input{Detector2_cor}
%%\input{Appendix_BDT}
\input{PIDchap_cor}
\input{Selection2_cor}
\input{Background_cor}
\input{Efficiency_cor}
%% \input{BDT}
%% \input{MassFits}
 \input{Results2_cor}
%% \input{Conclusions}
...
\input{Appendix_Correlation}
\chapter{License}
\input{Appendix_License}
%% \clearpage
%% \phantomsection
%%\addcontentsline{toc}{chapter}{List of Figures}
%%\listoffigures
