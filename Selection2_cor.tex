...
The overall selection results in 1198 candidates when signal region is blinded. There are no events with multiple candidates. The total efficiency for selecting the signal is about 0.1\%. The blinded data can be seen in~\autoref{fig:blsel}. 
