...
cancel. There are, however, efficiencies that will not cancel and will be necessary for the final limit setting procedure. In this section, methods of obtaining efficiencies of selection for normalisation and signal channel are described. Later, fitting procedure is outlined.}
...
The summary of individual efficiencies together with total efficiency for NOFCME, which is calculated for signal using nominator of~\autoref{eq:notsplitted} and for normalisation denominator of~\autoref{eq:notsplitted}, is given in~\autoref{tab:effsumarry}. 
...
\label{eq:nofcmeer}
\end{equation}
Including fractional corrected mass split efficiency ratios defined in~\autoref{eq:splitted} are
...
\begin{table}
	\begin{center}
      ...
      \multicolumn{10}{c}{\textbf{MC Default}} \\ \hline
