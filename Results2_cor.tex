...
\bottomrule
\end{tabular}
\caption{Resulting exclusion limits with simultaneous fit. The differences in the expected limits compared to those shown in~\autoref{tab:explimits} are due to the increase in data stastistics as well as different fit parameter values.}
\label{tab:limits}
\end{table}
