...
Further selection was performed as seen in \autoref{tab:OfflineSelection}. It further hepls to suppress backgrounds and but requires different treatement in 
Run \Rn{1} and Run \Rn{2} due to the different definitions of variables. 
...
%    \begin{tabular}{ | l | c |  } %p{7cm}|}
      Idea & Object & Selection Run1 & Selection 2016 \\ \hline
      Clean & Muon & - & \texttt{IsMuonTight==1.0}\\
      Clone and ghost & Muon & \texttt{Nshared==0} & \texttt{Nshared<2} \\
      Fit Region & $B$ & 4000 MeV $<M_{B_{corr}}<$ 7000 MeV & 4000 MeV $<M_{B_{corr}}<$ 7000 MeV \\
      ...
      Optimize FOM & Muon & \texttt{PID$\mu$>0.35} & \texttt{PID$\mu$>0.35} \\
      \hline
