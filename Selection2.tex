...
\hline
Bplus$\_$L0MuonDecision$\_$TOS \\ %& 0.915 & 0.895 & 0.74 \\
\hline
Bplus$\_$Hlt1TrackMuonDecision$\_$TOS \\% & 0.874 & 0.929 & 0.931 \\
%Or of HLT2 lines below & 0.986 & 0.987 & 0.996  \\
\hline
Bplus$\_$Hlt2TopoMu2BodyBBDTDecision$\_$TOS \\ % & 0.859 & 0.892 & 0.94* \\
Bplus$\_$Hlt2TopoMu3BodyBBDTDecision$\_$TOS \\ % & 0.677 & 0.76 & 0.886* \\
Bplus$\_$Hlt2DiMuonDetachedDecision$\_$TOS \\ % & 0.809 & 0.769 & 0.988 \\
Bplus$\_$Hlt2DiMuonDetachedHeavyDecision$\_$TOS \\ % & 0.94 & 0.929 & 0.99 \\
\hline
\end{tabular}
\end{center}
