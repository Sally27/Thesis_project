...
The model denoted as \textit{INSP} is used as default model for shapes in mass fits and efficiency calculations, where more information on its properties was given in~\autoref{simulation}.
