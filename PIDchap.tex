...
The shape of genuine resonance comes as an interplay between trigger, tracking and vertexing. As there are three parallel tracks.
In order to supress these peaks requiring \texttt{nShared==0} removes all of the clones.
