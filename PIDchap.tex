...
\section{Probability of \mb{K/\pi \rightarrow \mu} misidentification at LHCb \mybox{ULRIK}}
...
\subsection{Specific control sample for \mb{K/\pi \rightarrow \mu} misid rates \mybox{ULRIK}}
\label{extraction}
...
\subsection{Selection for \mb{B^{0} \rightarrow J/\psi(\rightarrow \mu^{+} \mu^{-}) K^{*}} \mybox{ULRIK} }
...
\subsection{Fitting Strategy for \mb{B^{0} \rightarrow J/\psi(\rightarrow \mu^{+} \mu^{-}) K^{*}} decay \mybox{ULRIK}}
...
\subsection{Results of  \mb{B^{0} \rightarrow J/\psi(\rightarrow \mu^{+} \mu^{-}) K^{*}} control sample for \mb{K/\pi \rightarrow \mu} misid rates \mybox{ULRIK}}
...
In conclusion, it was shown that the standard misID samples are not good proxy for estimating the misid probabilities as there is interference from two other muons in the event. Instead, the misid probabilities that are used in calculations for the misid background for \Bmumumu are obtained from \textit{Sweighted} $B^{0} \rightarrow J/\psi(\rightarrow \mu^{+} \mu^{-}) K^{*}$. Remaining effects of taking this sample for calibration are considered as a systematic uncertainty. \mybox{forward reference to misid templating}.
