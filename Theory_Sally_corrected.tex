...
\cite{Glashow:1961tr,Weinberg:1967tq,Salam:1968rm,Higgs:1966ev,Kibble:1967sv} }%DIFAUXCMD
...
\DIFadd{Use the following relation 
...
\caption{\DIFaddFL{$q^{2}(\mu^{+},\mu^{-})$ distribution using model the VDM model. The contribution from photon pole, $\rho$ and $\omega$ can be seen. This Figure was produced by a collaborator.}}
\label{fig:nikmodq2}
\end{figure}
\DIFaddend 
