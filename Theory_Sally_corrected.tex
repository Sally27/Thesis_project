...
Finally, there is a decay model based on calculations from \DIFaddbegin \DIFadd{the }\DIFaddend VMD model, which was written by authors of \cite{Danilina:2018uzr}. This model \DIFaddbegin \DIFadd{is }\DIFaddend denoted as \textit{NIKI}.
