...
\begin{figure}[!h]
	...
	\caption{Separation power for different species of particles in momentum-\v{C}erenkov angle plane (left). Schematic diagram of RICH1 layout (right). Boths figures are taken from \cite{det_paper}.}
	\label{fig:richres}
\end{figure}
