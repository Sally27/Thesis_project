...
\bottomrule
\end{tabular}
\caption{Resulting exclusion limits with simultaneous fit. \DIFaddbeginFL \DIFaddFL{Difference compared to expected limits, shown in~}\autoref{tab:explimits}\DIFaddFL{, is observed and it is due to the increase in data as well as different fit parameter values.}\DIFaddendFL }
\label{tab:limits}
\end{table}
